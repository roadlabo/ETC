...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        body3 = QWidget(); l3 = QHBoxLayout(body3); l3.setContentsMargins(0, 0, 0, 0); l3.setSpacing(10); l3.addWidget(QLabel("ルート名")); l3.addWidget(self.name_edit); l3.addWidget(QLabel("ピッチ")); l3.addWidget(self.pitch_spin); l3.addWidget(self.pitch_hint); l3.addWidget(self.btn_save)
